# Bryan Stanski's Style Stage

Features and design choices used on my page:
...
[CSS Mini Reset/Normalize Library](https://github.com/vladocar/CSS-Mini-Reset/blob/master/CSS-Mini-Reset.css)
